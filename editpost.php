...
<?php 
	if(isset($_POST["submit"])){
		...
		elseif(strlen($title)<2){
			...
			$query="UPDATE admin_panel SET dateandtime='$DateTime',title='$title',category='$category',author='$Admin',image='$image',post='$post' WHERE id='$editfromurl'";
		  	...
		  	<div>
				...
				<form action="editpost.php?edit=<?php echo $searchqueryparameter; ?>" method="post" enctype="multipart/form-data">
					<fieldset>
						...
						<input class="form-control" type="text" name="title" id="categoryname" placeholder="Title" value="<?php echo $uptitle; ?>">
						</div>
						<div class="form-group">
